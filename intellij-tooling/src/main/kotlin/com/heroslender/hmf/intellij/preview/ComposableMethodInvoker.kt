...
object ComposableInvoker {
    ...
    fun getComposableMethod(composableClass: Class<*>, methodName: String, vararg args: Any?): Method {
        return composableClass.findComposableMethod(methodName, *args)
            ?: throw NoSuchMethodException("Composable ${composableClass.name}.$methodName not found")
    }

    @ExperimentalComposeApi
    fun invokeComposable(composableClass: Class<*>, method: Method, composer: Composer, vararg args: Any?) {
        try {
            ...
            println("Failed to invoke Composable Method '${composableClass.name}.${method.name}'")
            throw e
        }
    }
    ...
    fun invokeComposable(
        ...
        try {
            ...
            println("Failed to invoke Composable Method '$className.$methodName'")
            throw e
        }
    }
}