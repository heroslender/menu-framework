...
open class PreviewCanvas(
    ...
    constructor(other: PreviewCanvas) : this(other.width, other.height, other.buffer.clone())

    override fun clone(): Canvas {
        return PreviewCanvas(this)
    }
    ...
    override fun newCanvas(width: Int, height: Int): Canvas = PreviewCanvas(width, height)

    override fun subCanvas(width: Int, height: Int, offsetX: Int, offsetY: Int): Canvas {
        val canvas = PreviewCanvas(width, height)
